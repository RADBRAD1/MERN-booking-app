...
const DetailsSection = () => {
    ...
    //formState: {errors} imports the errors state. destructures formstate from errors
    // which we get from useFormContext() call. 
    //also have to add <HotelFormData> after useformcontext b/c errors.name.message would throw error. 
    return (
